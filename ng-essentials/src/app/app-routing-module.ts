...
const routes: Routes = [
  {
    ...
    title: (route: ActivatedRouteSnapshot) =>
      `Treasure Hunter | Profile for ${route.paramMap.get('id')}`,
  },
  {
    path: 'players',
    loadChildren: () =>
      import('./pages/players/players.module').then((m) => m.PlayersModule),
    title: 'Treasure Hunter | All Players',
    data: { preload: true },
  },
  {
    path: 'leaderboards',
    loadChildren: () =>
      import('./pages/leaderboards/leaderboards.module').then(
        (m) => m.LeaderboardsModule
      ),
    title: 'Treasure Hunter | Leaderboards',
  },
  {
    path: 'messages',
    loadComponent: () =>
