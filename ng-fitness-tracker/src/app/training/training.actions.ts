...
export const TrainingActions = createActionGroup({
  source: 'Training',
  events: {
    'Set Available Trainings': props<{ availableExercises: Exercise[] }>(),
    'Set Finished Trainings': props<{ finishedExercises: Exercise[] }>(),
    'Start Training': props<{ id: string }>(),
    'Stop Training': emptyProps(),
  },
});
