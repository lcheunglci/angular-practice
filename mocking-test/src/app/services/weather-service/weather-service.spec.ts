...
describe('WeatherService', () => {
  ...
  beforeEach(() => {
    ...
    // const { TestBed } = await render(WeatherService, {
    //   providers: [
    //     WeatherService,
    //     provideHttpClient(),
    //     provideHttpClientTesting(),
  ...
  it('should fetch weather data and return it as an observable (Test the service)', async () => {
    ...
    req.flush(mockedResponse); //Set how your response looks prior to data transforms
